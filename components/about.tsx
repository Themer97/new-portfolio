    ...
    >
      ...
      <p className="mb-3">
        ...
        <span className="font-medium">
          Land surveying and geomatics(GIS) engineering
        </span>
      ...
      <p>
        ...
        out, playing video games, and watching movies. I also enjoy{" "}
        <span className="font-medium">learning new things</span>. I am currently
        learning about{" "}
        <span className="font-medium">
          how to implement my coding skills into my previous domain which is
