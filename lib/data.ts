...
export const projectsData = [
  {
    title: "Unidrive",
    description:
      "Driving schools app,where both schools and students interact with each other. I got involved in the implementation and dynamisation of this app.",
  ...
  },
  {
    title: "MyInspire",
    description:
      "internal company app. We can using this app demand daysoff, remote work or authorizations. Also we can check our balances,I got in charge of the web and mobile app.",
  ...
  },
  {
    title: "Baby World",
    description:
      "A tracking app for pharmaceutical company to track their medical representatives. I got involved in the implementation and dynamisation of this app.",
